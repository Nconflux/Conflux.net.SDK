...
using Conflux.RPC.Reactive.Eth;
using Conflux.RPC.Reactive.Eth.Subscriptions;
using Conflux.RPC.Reactive.Extensions;

namespace Conflux.WebSocketsStreamingTest
{
    class Program
    {
