...
*/
        ...
        public async void ShouldCallDifferentContractsUsingDataBytesArraysFixedAndVariable()
        {
            if (_ethereumClientIntegrationFixture.Geth)
            {
                ...
                var deploymentHandler = web3.Cfx.GetContractDeploymentHandler<TheOtherDeployment>();
                var deploymentReceipt = await deploymentHandler.SendRequestAndWaitForReceiptAsync();

                var deploymentCallerHandler = web3.Cfx.GetContractDeploymentHandler<TestDeployment>();
                ...
                var contracthandler = web3.Cfx.GetContractHandler(deploymentReceiptCaller.ContractAddress);
