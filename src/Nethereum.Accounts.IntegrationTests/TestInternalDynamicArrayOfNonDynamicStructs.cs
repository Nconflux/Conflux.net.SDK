...
*/
        ...
        public async void ShouldEncodeDecodeStructContainingStructsArray()
        {
            ...
            var deploymentReceipt = await web3.Cfx.GetContractDeploymentHandler<StructsSampleDeployment>()
            ...
            var query2 = await contractHandler.QueryDeserializingToObjectAsync<GetPurchaseOrdersFunction, GetPurchaseOrdersOutputDTO>();
            /*
              constructor() public {
            _purchaseOrder.id = 1;
            _purchaseOrder.customerId = 2;
