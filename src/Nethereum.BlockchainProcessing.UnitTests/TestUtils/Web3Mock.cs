...
namespace Nethereum.BlockchainProcessing.UnitTests.TestUtils
{
    public class Web3Mock
    {
        ...
        public Mock<ICfxApiContractService> EthApiContractServiceMock = new Mock<ICfxApiContractService>();
        ...
        public ICfxApiContractService Eth => EthApiContractServiceMock.Object;

        public Web3Mock()
        {
            Mock.Setup(m => m.Cfx).Returns(EthApiContractServiceMock.Object);
