...
namespace Conflux.RPC.Shh.KeyPair
{
    ...
    ///     }
    /// </Summary>
    public class ShhNewKeyPair : GenericRpcRequestResponseHandlerNoParam<string>, IShhNewKeyPair
    {
        public ShhNewKeyPair(IClient client) : base(client, ApiMethods.shh_newKeyPair.ToString())
        {
        }
    }
}