...
namespace Conflux.RPC.Eth
{
    ...
    ///     }
    /// </Summary>
    public class EthGetNextNonce : RpcRequestResponseHandler<HexBigInteger>, IDefaultBlock, IEthGetNextNonce
    {
        public EthGetNextNonce() : this(null)
        {
        }

        public EthGetNextNonce(IClient client) : base(client, ApiMethods.cfx_getNextNonce.ToString())
        {
        ...
        public Task<HexBigInteger> SendRequestAsync(string address, BlockParameter block, object id = null)
        {
            ...
            //DefaultBlock.WalletAddress = address;
            return base.SendRequestAsync(id, address.EnsureHexPrefix(), "latest_state");
        }
