...
namespace Conflux.RPC.Eth
{
    ...
    ///     }
    /// </Summary>
    public class EthGetEpochNumber : RpcRequestResponseHandler<HexBigInteger>, IDefaultBlock, IEthGetEpochNumber
    {
        public EthGetEpochNumber() : this(null)
        {
        }

        public EthGetEpochNumber(IClient client) : base(client, ApiMethods.cfx_epochNumber.ToString())
        {
        ...
        {
            DefaultBlock.WalletAddress = null;
