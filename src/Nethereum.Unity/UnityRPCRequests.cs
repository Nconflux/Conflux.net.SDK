...
namespace Conflux.JsonRpc.UnityClient
{
    ...
    {
        private readonly Conflux.RPC.Web3.Web3ClientVersion _web3ClientVersion;
        ...
        {
            _web3ClientVersion = new Conflux.RPC.Web3.Web3ClientVersion(null);
        }
    ...
    {
        private readonly Conflux.RPC.Web3.Web3Sha3 _web3Sha3;
        ...
        {
            _web3Sha3 = new Conflux.RPC.Web3.Web3Sha3(null);
        }

        public IEnumerator SendRequest(Conflux.Hex.HexTypes.HexUTF8String valueToConvert)
        {
    ...
    {
        private readonly Conflux.RPC.Shh.KeyPair.ShhNewKeyPair _shhNewKeyPair;
        ...
        {
            _shhNewKeyPair = new Conflux.RPC.Shh.KeyPair.ShhNewKeyPair(null);
        }
    ...
    {
        private readonly Conflux.RPC.Shh.KeyPair.ShhAddPrivateKey _addPrivateKey;
        ...
        {
            _addPrivateKey = new Conflux.RPC.Shh.KeyPair.ShhAddPrivateKey(null);
        }
    ...
    {
        private readonly Conflux.RPC.Shh.ShhVersion _shhVersion;
        ...
        {
            _shhVersion = new Conflux.RPC.Shh.ShhVersion(null);
        }
    ...
    {
        private readonly Conflux.RPC.Personal.PersonalListAccounts _personalListAccounts;
        ...
        {
            _personalListAccounts = new Conflux.RPC.Personal.PersonalListAccounts(null);
        }
    ...
    {
        private readonly Conflux.RPC.Personal.PersonalLockAccount _personalLockAccount;
        ...
        {
            _personalLockAccount = new Conflux.RPC.Personal.PersonalLockAccount(null);
        }
    ...
    {
        private readonly Conflux.RPC.Personal.PersonalNewAccount _personalNewAccount;
        ...
        {
            _personalNewAccount = new Conflux.RPC.Personal.PersonalNewAccount(null);
        }
    ...
    {
        private readonly Conflux.RPC.Personal.PersonalSignAndSendTransaction _personalSignAndSendTransaction;
        ...
        {
            _personalSignAndSendTransaction = new Conflux.RPC.Personal.PersonalSignAndSendTransaction(null);
        }

        public IEnumerator SendRequest(Conflux.RPC.Eth.DTOs.TransactionInput txn, System.String password)
        {
    ...
    {
        private readonly Conflux.RPC.Personal.PersonalUnlockAccount _personalUnlockAccount;
        ...
        {
            _personalUnlockAccount = new Conflux.RPC.Personal.PersonalUnlockAccount(null);
        }
    ...
    {
        private readonly Conflux.RPC.Net.NetListening _netListening;
        ...
        {
            _netListening = new Conflux.RPC.Net.NetListening(null);
        }
    ...
    public class NetPeerCountUnityRequest:UnityRpcClient<Conflux.Hex.HexTypes.HexBigInteger>
    {
        private readonly Conflux.RPC.Net.NetPeerCount _netPeerCount;
        ...
        {
            _netPeerCount = new Conflux.RPC.Net.NetPeerCount(null);
        }
    ...
    {
        private readonly Conflux.RPC.Net.NetVersion _netVersion;
        ...
        {
            _netVersion = new Conflux.RPC.Net.NetVersion(null);
        }
    ...
    {
        private readonly Conflux.RPC.Eth.EthAccounts _ethAccounts;
        ...
        {
            _ethAccounts = new Conflux.RPC.Eth.EthAccounts(null);
        }
    ...
    {
        private readonly Conflux.RPC.Eth.EthCoinBase _ethCoinBase;
        ...
        {
            _ethCoinBase = new Conflux.RPC.Eth.EthCoinBase(null);
        }
    ...
    public class EthGasPriceUnityRequest:UnityRpcClient<Conflux.Hex.HexTypes.HexBigInteger>
    {
        private readonly Conflux.RPC.Eth.EthGasPrice _ethGasPrice;
        ...
        {
            _ethGasPrice = new Conflux.RPC.Eth.EthGasPrice(null);
        }
    ...
    public class EthGetBalanceUnityRequest:UnityRpcClient<Conflux.Hex.HexTypes.HexBigInteger>
    {
        private readonly Conflux.RPC.Eth.EthGetBalance _ethGetBalance;
        ...
        {
            _ethGetBalance = new Conflux.RPC.Eth.EthGetBalance(null);
        }

        public IEnumerator SendRequest(System.String address, Conflux.RPC.Eth.DTOs.BlockParameter block)
        {
    ...
    {
        private readonly Conflux.RPC.Eth.EthGetCode _ethGetCode;
        ...
        {
            _ethGetCode = new Conflux.RPC.Eth.EthGetCode(null);
        }
    ...
    {
        private readonly Conflux.RPC.Eth.EthGetStorageAt _ethGetStorageAt;
        ...
        {
            _ethGetStorageAt = new Conflux.RPC.Eth.EthGetStorageAt(null);
        }

        public IEnumerator SendRequest(System.String address, Conflux.Hex.HexTypes.HexBigInteger position, Conflux.RPC.Eth.DTOs.BlockParameter block)
        {
    ...
    {
        private readonly Conflux.RPC.Eth.EthProtocolVersion _ethProtocolVersion;
        ...
        {
            _ethProtocolVersion = new Conflux.RPC.Eth.EthProtocolVersion(null);
        }
    ...
    {
        private readonly Conflux.RPC.Eth.EthSyncing _ethSyncing;
        ...
        {
            _ethSyncing = new Conflux.RPC.Eth.EthSyncing(null);
        }
    ...
    public class EthGetUncleByBlockHashAndIndexUnityRequest:UnityRpcClient<Conflux.RPC.Eth.DTOs.BlockWithTransactionHashes>
    {
        private readonly Conflux.RPC.Eth.Uncles.EthGetUncleByBlockHashAndIndex _ethGetUncleByBlockHashAndIndex;
        ...
        {
            _ethGetUncleByBlockHashAndIndex = new Conflux.RPC.Eth.Uncles.EthGetUncleByBlockHashAndIndex(null);
        }

        public IEnumerator SendRequest(System.String blockHash, Conflux.Hex.HexTypes.HexBigInteger uncleIndex)
        {
    ...
    public class EthGetUncleByBlockNumberAndIndexUnityRequest:UnityRpcClient<Conflux.RPC.Eth.DTOs.BlockWithTransactionHashes>
    {
        private readonly Conflux.RPC.Eth.Uncles.EthGetUncleByBlockNumberAndIndex _ethGetUncleByBlockNumberAndIndex;
        ...
        {
            _ethGetUncleByBlockNumberAndIndex = new Conflux.RPC.Eth.Uncles.EthGetUncleByBlockNumberAndIndex(null);
        }

        public IEnumerator SendRequest(Conflux.RPC.Eth.DTOs.BlockParameter blockParameter, Conflux.Hex.HexTypes.HexBigInteger uncleIndex)
        {
    ...
    public class EthGetUncleCountByBlockHashUnityRequest:UnityRpcClient<Conflux.Hex.HexTypes.HexBigInteger>
    {
        private readonly Conflux.RPC.Eth.Uncles.EthGetUncleCountByBlockHash _ethGetUncleCountByBlockHash;
        ...
        {
            _ethGetUncleCountByBlockHash = new Conflux.RPC.Eth.Uncles.EthGetUncleCountByBlockHash(null);
        }
    ...
    public class EthGetUncleCountByBlockNumberUnityRequest:UnityRpcClient<Conflux.Hex.HexTypes.HexBigInteger>
    {
        private readonly Conflux.RPC.Eth.Uncles.EthGetUncleCountByBlockNumber _ethGetUncleCountByBlockNumber;
        ...
        {
            _ethGetUncleCountByBlockNumber = new Conflux.RPC.Eth.Uncles.EthGetUncleCountByBlockNumber(null);
        }

        public IEnumerator SendRequest(Conflux.Hex.HexTypes.HexBigInteger blockNumber)
        {
    ...
    {
        private readonly Conflux.RPC.Eth.Transactions.EthCall _ethCall;

        public EthCallUnityRequest(string url, JsonSerializerSettings jsonSerializerSettings = null):base(url, jsonSerializerSettings)
        {
            _ethCall = new Conflux.RPC.Eth.Transactions.EthCall(null);
        }

        public IEnumerator SendRequest(Conflux.RPC.Eth.DTOs.CallInput callInput, Conflux.RPC.Eth.DTOs.BlockParameter block)
        {
    ...
    public class EthEstimateGasUnityRequest:UnityRpcClient<Conflux.Hex.HexTypes.HexBigInteger>
    {
        private readonly Conflux.RPC.Eth.Transactions.EthEstimateGas _ethEstimateGas;
        ...
        {
            _ethEstimateGas = new Conflux.RPC.Eth.Transactions.EthEstimateGas(null);
        }

        public IEnumerator SendRequest(Conflux.RPC.Eth.DTOs.CallInput callInput)
        {
    ...
    public class EthGetTransactionByBlockHashAndIndexUnityRequest:UnityRpcClient<Conflux.RPC.Eth.DTOs.Transaction>
    {
        private readonly Conflux.RPC.Eth.Transactions.EthGetTransactionByBlockHashAndIndex _ethGetTransactionByBlockHashAndIndex;
        ...
        {
            _ethGetTransactionByBlockHashAndIndex = new Conflux.RPC.Eth.Transactions.EthGetTransactionByBlockHashAndIndex(null);
        }

        public IEnumerator SendRequest(System.String blockHash, Conflux.Hex.HexTypes.HexBigInteger transactionIndex)
        {
    ...
    public class EthGetTransactionByBlockNumberAndIndexUnityRequest:UnityRpcClient<Conflux.RPC.Eth.DTOs.Transaction>
    {
        private readonly Conflux.RPC.Eth.Transactions.EthGetTransactionByBlockNumberAndIndex _ethGetTransactionByBlockNumberAndIndex;
        ...
        {
            _ethGetTransactionByBlockNumberAndIndex = new Conflux.RPC.Eth.Transactions.EthGetTransactionByBlockNumberAndIndex(null);
        }

        public IEnumerator SendRequest(Conflux.Hex.HexTypes.HexBigInteger blockNumber, Conflux.Hex.HexTypes.HexBigInteger transactionIndex)
        {
    ...
    public class EthGetTransactionByHashUnityRequest:UnityRpcClient<Conflux.RPC.Eth.DTOs.Transaction>
    {
        private readonly Conflux.RPC.Eth.Transactions.EthGetTransactionByHash _ethGetTransactionByHash;
        ...
        {
            _ethGetTransactionByHash = new Conflux.RPC.Eth.Transactions.EthGetTransactionByHash(null);
        }
    ...
    public class EthGetTransactionCountUnityRequest:UnityRpcClient<Conflux.Hex.HexTypes.HexBigInteger>
    {
        private readonly Conflux.RPC.Eth.Transactions.EthGetTransactionCount _ethGetTransactionCount;
        ...
        {
            _ethGetTransactionCount = new Conflux.RPC.Eth.Transactions.EthGetTransactionCount(null);
        }
    ...
    public class EthGetTransactionReceiptUnityRequest:UnityRpcClient<Conflux.RPC.Eth.DTOs.TransactionReceipt>
    {
        private readonly Conflux.RPC.Eth.Transactions.EthGetTransactionReceipt _ethGetTransactionReceipt;
        ...
        {
            _ethGetTransactionReceipt = new Conflux.RPC.Eth.Transactions.EthGetTransactionReceipt(null);
        }
    ...
    {
        private readonly Conflux.RPC.Eth.Transactions.EthSendRawTransaction _ethSendRawTransaction;
        ...
        {
            _ethSendRawTransaction = new Conflux.RPC.Eth.Transactions.EthSendRawTransaction(null);
        }
    ...
    {
        private readonly Conflux.RPC.Eth.Transactions.EthSendTransaction _ethSendTransaction;
        ...
        {
            _ethSendTransaction = new Conflux.RPC.Eth.Transactions.EthSendTransaction(null);
        }

        public IEnumerator SendRequest(Conflux.RPC.Eth.DTOs.TransactionInput input)
        {
    ...
    {
        private readonly Conflux.RPC.Eth.Mining.EthGetWork _ethGetWork;
        ...
        {
            _ethGetWork = new Conflux.RPC.Eth.Mining.EthGetWork(null);
        }
    ...
    public class EthHashrateUnityRequest:UnityRpcClient<Conflux.Hex.HexTypes.HexBigInteger>
    {
        private readonly Conflux.RPC.Eth.Mining.EthHashrate _ethHashrate;
        ...
        {
            _ethHashrate = new Conflux.RPC.Eth.Mining.EthHashrate(null);
        }
    ...
    {
        private readonly Conflux.RPC.Eth.Mining.EthMining _ethMining;
        ...
        {
            _ethMining = new Conflux.RPC.Eth.Mining.EthMining(null);
        }
    ...
    {
        private readonly Conflux.RPC.Eth.Mining.EthSubmitHashrate _ethSubmitHashrate;
        ...
        {
            _ethSubmitHashrate = new Conflux.RPC.Eth.Mining.EthSubmitHashrate(null);
        }
    ...
    {
        private readonly Conflux.RPC.Eth.Mining.EthSubmitWork _ethSubmitWork;
        ...
        {
            _ethSubmitWork = new Conflux.RPC.Eth.Mining.EthSubmitWork(null);
        }
    ...
    public class EthGetFilterChangesForEthNewFilterUnityRequest:UnityRpcClient<Conflux.RPC.Eth.DTOs.FilterLog[]>
    {
        private readonly Conflux.RPC.Eth.Filters.EthGetFilterChangesForEthNewFilter _ethGetFilterChangesForEthNewFilter;
        ...
        {
            _ethGetFilterChangesForEthNewFilter = new Conflux.RPC.Eth.Filters.EthGetFilterChangesForEthNewFilter(null);
        }

        public IEnumerator SendRequest(Conflux.Hex.HexTypes.HexBigInteger filterId)
        {
    ...
    {
        private readonly Conflux.RPC.Eth.Filters.EthGetFilterChangesForBlockOrTransaction _ethGetFilterChangesForBlockOrTransaction;
        ...
        {
            _ethGetFilterChangesForBlockOrTransaction = new Conflux.RPC.Eth.Filters.EthGetFilterChangesForBlockOrTransaction(null);
        }
    ...
    {
        private readonly Conflux.RPC.Eth.Filters.EthGetFilterLogsForBlockOrTransaction _ethGetFilterLogsForBlockOrTransaction;
        ...
        {
            _ethGetFilterLogsForBlockOrTransaction = new Conflux.RPC.Eth.Filters.EthGetFilterLogsForBlockOrTransaction(null);
        }
    ...
    public class EthGetFilterLogsForEthNewFilterUnityRequest:UnityRpcClient<Conflux.RPC.Eth.DTOs.FilterLog[]>
    {
        private readonly Conflux.RPC.Eth.Filters.EthGetFilterLogsForEthNewFilter _ethGetFilterLogsForEthNewFilter;
        ...
        {
            _ethGetFilterLogsForEthNewFilter = new Conflux.RPC.Eth.Filters.EthGetFilterLogsForEthNewFilter(null);
        }
    ...
    public class EthGetLogsUnityRequest:UnityRpcClient<Conflux.RPC.Eth.DTOs.FilterLog[]>
    {
        private readonly Conflux.RPC.Eth.Filters.EthGetLogs _ethGetLogs;
        ...
        {
            _ethGetLogs = new Conflux.RPC.Eth.Filters.EthGetLogs(null);
        }

        public IEnumerator SendRequest(Conflux.RPC.Eth.DTOs.NewFilterInput newFilter)
        {
    ...
    public class EthNewBlockFilterUnityRequest:UnityRpcClient<Conflux.Hex.HexTypes.HexBigInteger>
    {
        private readonly Conflux.RPC.Eth.Filters.EthNewBlockFilter _ethNewBlockFilter;
        ...
        {
            _ethNewBlockFilter = new Conflux.RPC.Eth.Filters.EthNewBlockFilter(null);
        }
    ...
    public class EthNewFilterUnityRequest:UnityRpcClient<Conflux.Hex.HexTypes.HexBigInteger>
    {
        private readonly Conflux.RPC.Eth.Filters.EthNewFilter _ethNewFilter;
        ...
        {
            _ethNewFilter = new Conflux.RPC.Eth.Filters.EthNewFilter(null);
        }

        public IEnumerator SendRequest(Conflux.RPC.Eth.DTOs.NewFilterInput newFilterInput)
        {
    ...
    public class EthNewPendingTransactionFilterUnityRequest:UnityRpcClient<Conflux.Hex.HexTypes.HexBigInteger>
    {
        private readonly Conflux.RPC.Eth.Filters.EthNewPendingTransactionFilter _ethNewPendingTransactionFilter;
        ...
        {
            _ethNewPendingTransactionFilter = new Conflux.RPC.Eth.Filters.EthNewPendingTransactionFilter(null);
        }
    ...
    {
        private readonly Conflux.RPC.Eth.Filters.EthUninstallFilter _ethUninstallFilter;
        ...
        {
            _ethUninstallFilter = new Conflux.RPC.Eth.Filters.EthUninstallFilter(null);
        }
    ...
    {
        private readonly Conflux.RPC.Eth.Compilation.EthCompileLLL _ethCompileLLL;
        ...
        {
            _ethCompileLLL = new Conflux.RPC.Eth.Compilation.EthCompileLLL(null);
        }
    ...
    {
        private readonly Conflux.RPC.Eth.Compilation.EthCompileSerpent _ethCompileSerpent;
        ...
        {
            _ethCompileSerpent = new Conflux.RPC.Eth.Compilation.EthCompileSerpent(null);
        }
    ...
    {
        private readonly Conflux.RPC.Eth.Compilation.EthCompileSolidity _ethCompileSolidity;
        ...
        {
            _ethCompileSolidity = new Conflux.RPC.Eth.Compilation.EthCompileSolidity(null);
        }
    ...
    {
        private readonly Conflux.RPC.Eth.Compilation.EthGetCompilers _ethGetCompilers;
        ...
        {
            _ethGetCompilers = new Conflux.RPC.Eth.Compilation.EthGetCompilers(null);
        }
    ...
    public class EthBlockNumberUnityRequest:UnityRpcClient<Conflux.Hex.HexTypes.HexBigInteger>
    {
        private readonly Conflux.RPC.Eth.Blocks.EthBlockNumber _ethBlockNumber;
        ...
        {
            _ethBlockNumber = new Conflux.RPC.Eth.Blocks.EthBlockNumber(null);
        }
    ...
    public class EthGetBlockWithTransactionsByHashUnityRequest:UnityRpcClient<Conflux.RPC.Eth.DTOs.BlockWithTransactions>
    {
        private readonly Conflux.RPC.Eth.Blocks.EthGetBlockWithTransactionsByHash _ethGetBlockWithTransactionsByHash;
        ...
        {
            _ethGetBlockWithTransactionsByHash = new Conflux.RPC.Eth.Blocks.EthGetBlockWithTransactionsByHash(null);
        }
    ...
    public class EthGetBlockWithTransactionsHashesByHashUnityRequest:UnityRpcClient<Conflux.RPC.Eth.DTOs.BlockWithTransactionHashes>
    {
        private readonly Conflux.RPC.Eth.Blocks.EthGetBlockWithTransactionsHashesByHash _ethGetBlockWithTransactionsHashesByHash;
        ...
        {
            _ethGetBlockWithTransactionsHashesByHash = new Conflux.RPC.Eth.Blocks.EthGetBlockWithTransactionsHashesByHash(null);
        }
    ...
    public class EthGetBlockWithTransactionsByNumberUnityRequest:UnityRpcClient<Conflux.RPC.Eth.DTOs.BlockWithTransactions>
    {
        private readonly Conflux.RPC.Eth.Blocks.EthGetBlockWithTransactionsByNumber _ethGetBlockWithTransactionsByNumber;
        ...
        {
            _ethGetBlockWithTransactionsByNumber = new Conflux.RPC.Eth.Blocks.EthGetBlockWithTransactionsByNumber(null);
        }

        public IEnumerator SendRequest(Conflux.Hex.HexTypes.HexBigInteger number)
        {
    ...
    public class EthGetBlockTransactionCountByHashUnityRequest:UnityRpcClient<Conflux.Hex.HexTypes.HexBigInteger>
    {
        private readonly Conflux.RPC.Eth.Blocks.EthGetBlockTransactionCountByHash _ethGetBlockTransactionCountByHash;
        ...
        {
            _ethGetBlockTransactionCountByHash = new Conflux.RPC.Eth.Blocks.EthGetBlockTransactionCountByHash(null);
        }
    ...
    public class EthGetBlockTransactionCountByNumberUnityRequest:UnityRpcClient<Conflux.Hex.HexTypes.HexBigInteger>
    {
        private readonly Conflux.RPC.Eth.Blocks.EthGetBlockTransactionCountByNumber _ethGetBlockTransactionCountByNumber;
        ...
        {
            _ethGetBlockTransactionCountByNumber = new Conflux.RPC.Eth.Blocks.EthGetBlockTransactionCountByNumber(null);
        }

        public IEnumerator SendRequest(Conflux.RPC.Eth.DTOs.BlockParameter block)
        {
    ...
    public class EthGetBlockWithTransactionsHashesByNumberUnityRequest:UnityRpcClient<Conflux.RPC.Eth.DTOs.BlockWithTransactionHashes>
    {
        private readonly Conflux.RPC.Eth.Blocks.EthGetBlockWithTransactionsHashesByNumber _ethGetBlockWithTransactionsHashesByNumber;
        ...
        {
            _ethGetBlockWithTransactionsHashesByNumber = new Conflux.RPC.Eth.Blocks.EthGetBlockWithTransactionsHashesByNumber(null);
        }
