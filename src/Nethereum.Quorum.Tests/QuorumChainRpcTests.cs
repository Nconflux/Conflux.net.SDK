...
namespace Nethereum.Quorum.Tests
{
    ...
    public class QuorumChainRpcTests
    {
        ...
        {
            var web3 = new Web3Quorum(DefaultSettings.GetDefaultUrl());
            var isBlockMaker = await web3.Quorum.IsBlockMaker.SendRequestAsync(await web3.Cfx.CoinBase.SendRequestAsync());
        ...
        {
            var web3 = new Web3Quorum(DefaultSettings.GetDefaultUrl());
            var isVoter = await web3.Quorum.IsVoter.SendRequestAsync(await web3.Cfx.CoinBase.SendRequestAsync());
        ...
        public async void ShouldBeAbleToVote()
        {
            ...
            var block =
                await web3.Cfx.Blocks.GetBlockWithTransactionsByNumber.SendRequestAsync(BlockParameter.CreateLatest());
