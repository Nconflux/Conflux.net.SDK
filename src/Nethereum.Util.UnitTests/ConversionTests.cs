...
namespace Nethereum.Util.UnitTests
{
    public class ConversionTests
    {
        ...
        public void ShouldConvertFromDripToDecimal(int units, string expected, string weiAmount)
        {
            var unitConversion = new UnitConversion();
            var result = unitConversion.FromDrip(BigInteger.Parse(weiAmount), units);
        ...
        public void ShouldConvertFromDripToBigDecimal(int units, string expected, string weiAmount)
        {
            var unitConversion = new UnitConversion();
            var result = unitConversion.FromDripToBigDecimal(BigInteger.Parse(weiAmount), units);
            Assert.Equal(expected, result.ToString());
        }
        ...
        public void ShouldConverFromDrip()
        {
            ...
            var result = unitConversion.FromDrip(val, 18);
            var result2 = unitConversion.FromDrip(val);
            Assert.Equal(result, result2);
            result2 = unitConversion.FromDrip(val, BigInteger.Parse("1000000000000000000"));
            Assert.Equal(result, result2);
        ...
        [Fact]
        public void ShouldConvertFromDripAndBackToEth()
        {
            var unitConversion = new UnitConversion();
            var val = BigInteger.Parse("1000000000000000000000000001");
            var result = unitConversion.FromDrip(val, 18);
        ...
        public void ShouldConvertPeriodicGether()
        {
            ...
            var result = unitConversion.FromDrip(val, UnitConversion.EthUnit.Gether);
        ...
        public void ShouldConvertPeriodicTether()
        {
            ...
            var result = unitConversion.FromDripToBigDecimal(val, UnitConversion.EthUnit.Tether);
