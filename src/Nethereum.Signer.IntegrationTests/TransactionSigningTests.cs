...
namespace Nethereum.Signer.IntegrationTests
{
    ...
    public class TransactionSigningTests
    {
        ...
        public async Task<bool> ShouldSignAndSendRawTransaction()
        {
            ...
            var txCount = await web3.Cfx.Transactions.GetTransactionCount.SendRequestAsync(senderAddress);
            ...
            var txId = await web3.Cfx.Transactions.SendRawTransaction.SendRequestAsync("0x" + encoded);
