...
using Conflux.ENS.DNSRegister.ContractDefinition;

namespace Conflux.ENS
{
    public partial class DNSRegisterService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Conflux.Web3.Web3 web3, DNSRegisterDeployment dNSRegisterDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Cfx.GetContractDeploymentHandler<DNSRegisterDeployment>().SendRequestAndWaitForReceiptAsync(dNSRegisterDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Conflux.Web3.Web3 web3, DNSRegisterDeployment dNSRegisterDeployment)
        {
            return web3.Cfx.GetContractDeploymentHandler<DNSRegisterDeployment>().SendRequestAsync(dNSRegisterDeployment);
        }

        public static async Task<DNSRegisterService> DeployContractAndGetServiceAsync(Conflux.Web3.Web3 web3, DNSRegisterDeployment dNSRegisterDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public DNSRegisterService(Conflux.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
