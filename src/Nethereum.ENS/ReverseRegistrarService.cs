...
using Conflux.ENS.ReverseRegistrar.ContractDefinition;

namespace Conflux.ENS
{
    public partial class ReverseRegistrarService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Conflux.Web3.Web3 web3, ReverseRegistrarDeployment reverseRegistrarDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Cfx.GetContractDeploymentHandler<ReverseRegistrarDeployment>().SendRequestAndWaitForReceiptAsync(reverseRegistrarDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Conflux.Web3.Web3 web3, ReverseRegistrarDeployment reverseRegistrarDeployment)
        {
            return web3.Cfx.GetContractDeploymentHandler<ReverseRegistrarDeployment>().SendRequestAsync(reverseRegistrarDeployment);
        }

        public static async Task<ReverseRegistrarService> DeployContractAndGetServiceAsync(Conflux.Web3.Web3 web3, ReverseRegistrarDeployment reverseRegistrarDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public ReverseRegistrarService(Conflux.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
