...
using Conflux.ENS.ETHRegistrarController.ContractDefinition;

namespace Conflux.ENS
{
    public partial class ETHRegistrarControllerService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Conflux.Web3.Web3 web3, ETHRegistrarControllerDeployment eTHRegistrarControllerDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Cfx.GetContractDeploymentHandler<ETHRegistrarControllerDeployment>().SendRequestAndWaitForReceiptAsync(eTHRegistrarControllerDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Conflux.Web3.Web3 web3, ETHRegistrarControllerDeployment eTHRegistrarControllerDeployment)
        {
            return web3.Cfx.GetContractDeploymentHandler<ETHRegistrarControllerDeployment>().SendRequestAsync(eTHRegistrarControllerDeployment);
        }

        public static async Task<ETHRegistrarControllerService> DeployContractAndGetServiceAsync(Conflux.Web3.Web3 web3, ETHRegistrarControllerDeployment eTHRegistrarControllerDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, eTHRegistrarControllerDeployment, cancellationTokenSource);
        ...
        public ETHRegistrarControllerService(Conflux.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
