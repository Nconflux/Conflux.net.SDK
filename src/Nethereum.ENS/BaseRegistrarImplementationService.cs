...
using Conflux.ENS.BaseRegistrarImplementation.ContractDefinition;

namespace Conflux.ENS
{
    public partial class BaseRegistrarImplementationService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Conflux.Web3.Web3 web3, BaseRegistrarImplementationDeployment baseRegistrarImplementationDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Cfx.GetContractDeploymentHandler<BaseRegistrarImplementationDeployment>().SendRequestAndWaitForReceiptAsync(baseRegistrarImplementationDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Conflux.Web3.Web3 web3, BaseRegistrarImplementationDeployment baseRegistrarImplementationDeployment)
        {
            return web3.Cfx.GetContractDeploymentHandler<BaseRegistrarImplementationDeployment>().SendRequestAsync(baseRegistrarImplementationDeployment);
        }

        public static async Task<BaseRegistrarImplementationService> DeployContractAndGetServiceAsync(Conflux.Web3.Web3 web3, BaseRegistrarImplementationDeployment baseRegistrarImplementationDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public BaseRegistrarImplementationService(Conflux.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
