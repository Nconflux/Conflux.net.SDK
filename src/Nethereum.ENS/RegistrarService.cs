...
using Conflux.ENS.Registrar.ContractDefinition;
...
namespace Conflux.ENS
{
    ...
    public partial class RegistrarService
    {
        ...
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Conflux.Web3.Web3 web3, RegistrarDeployment registrarDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Cfx.GetContractDeploymentHandler<RegistrarDeployment>().SendRequestAndWaitForReceiptAsync(registrarDeployment, cancellationTokenSource);
        }
        public static Task<string> DeployContractAsync(Conflux.Web3.Web3 web3, RegistrarDeployment registrarDeployment)
        {
            return web3.Cfx.GetContractDeploymentHandler<RegistrarDeployment>().SendRequestAsync(registrarDeployment);
        }
        public static async Task<RegistrarService> DeployContractAndGetServiceAsync(Conflux.Web3.Web3 web3, RegistrarDeployment registrarDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public RegistrarService(Conflux.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
