...
using Conflux.ENS.Deed.ContractDefinition;
...
namespace Conflux.ENS
{
    ...
    public partial class DeedService
    {
        ...
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Conflux.Web3.Web3 web3, DeedDeployment deedDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Cfx.GetContractDeploymentHandler<DeedDeployment>().SendRequestAndWaitForReceiptAsync(deedDeployment, cancellationTokenSource);
        }
        public static Task<string> DeployContractAsync(Conflux.Web3.Web3 web3, DeedDeployment deedDeployment)
        {
            return web3.Cfx.GetContractDeploymentHandler<DeedDeployment>().SendRequestAsync(deedDeployment);
        }
        public static async Task<DeedService> DeployContractAndGetServiceAsync(Conflux.Web3.Web3 web3, DeedDeployment deedDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public DeedService(Conflux.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
