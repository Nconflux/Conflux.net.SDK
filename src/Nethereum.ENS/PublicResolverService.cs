...
using Conflux.ENS.PublicResolver.ContractDefinition;

namespace Conflux.ENS
{
    public partial class PublicResolverService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Conflux.Web3.Web3 web3, PublicResolverDeployment publicResolverDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Cfx.GetContractDeploymentHandler<PublicResolverDeployment>().SendRequestAndWaitForReceiptAsync(publicResolverDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Conflux.Web3.Web3 web3, PublicResolverDeployment publicResolverDeployment)
        {
            return web3.Cfx.GetContractDeploymentHandler<PublicResolverDeployment>().SendRequestAsync(publicResolverDeployment);
        }

        public static async Task<PublicResolverService> DeployContractAndGetServiceAsync(Conflux.Web3.Web3 web3, PublicResolverDeployment publicResolverDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public PublicResolverService(Conflux.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
