...
using Conflux.ENS.ShortNameClaims.ContractDefinition;

namespace Conflux.ENS
{
    public partial class ShortNameClaimsService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Conflux.Web3.Web3 web3, ShortNameClaimsDeployment shortNameClaimsDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Cfx.GetContractDeploymentHandler<ShortNameClaimsDeployment>().SendRequestAndWaitForReceiptAsync(shortNameClaimsDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Conflux.Web3.Web3 web3, ShortNameClaimsDeployment shortNameClaimsDeployment)
        {
            return web3.Cfx.GetContractDeploymentHandler<ShortNameClaimsDeployment>().SendRequestAsync(shortNameClaimsDeployment);
        }

        public static async Task<ShortNameClaimsService> DeployContractAndGetServiceAsync(Conflux.Web3.Web3 web3, ShortNameClaimsDeployment shortNameClaimsDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public ShortNameClaimsService(Conflux.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
