...
using Conflux.ENS.EthRegistrarSubdomainRegistrar.ContractDefinition;

namespace Conflux.ENS
{
    public partial class EthRegistrarSubdomainRegistrarService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Conflux.Web3.Web3 web3, EthRegistrarSubdomainRegistrarDeployment ethRegistrarSubdomainRegistrarDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Cfx.GetContractDeploymentHandler<EthRegistrarSubdomainRegistrarDeployment>().SendRequestAndWaitForReceiptAsync(ethRegistrarSubdomainRegistrarDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Conflux.Web3.Web3 web3, EthRegistrarSubdomainRegistrarDeployment ethRegistrarSubdomainRegistrarDeployment)
        {
            return web3.Cfx.GetContractDeploymentHandler<EthRegistrarSubdomainRegistrarDeployment>().SendRequestAsync(ethRegistrarSubdomainRegistrarDeployment);
        }

        public static async Task<EthRegistrarSubdomainRegistrarService> DeployContractAndGetServiceAsync(Conflux.Web3.Web3 web3, EthRegistrarSubdomainRegistrarDeployment ethRegistrarSubdomainRegistrarDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public EthRegistrarSubdomainRegistrarService(Conflux.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
