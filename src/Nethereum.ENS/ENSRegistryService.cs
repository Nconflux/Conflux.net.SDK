...
using Conflux.ENS.ENSRegistry.ContractDefinition;

namespace Conflux.ENS
{
    public partial class ENSRegistryService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Conflux.Web3.Web3 web3, ENSRegistryDeployment eNSRegistryDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Cfx.GetContractDeploymentHandler<ENSRegistryDeployment>().SendRequestAndWaitForReceiptAsync(eNSRegistryDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Conflux.Web3.Web3 web3, ENSRegistryDeployment eNSRegistryDeployment)
        {
            return web3.Cfx.GetContractDeploymentHandler<ENSRegistryDeployment>().SendRequestAsync(eNSRegistryDeployment);
        }

        public static async Task<ENSRegistryService> DeployContractAndGetServiceAsync(Conflux.Web3.Web3 web3, ENSRegistryDeployment eNSRegistryDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public ENSRegistryService(Conflux.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
