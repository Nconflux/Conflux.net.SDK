...
using Conflux.ENS.ENSRegistryWithFallback.ContractDefinition;

namespace Conflux.ENS
{
    public partial class ENSRegistryWithFallbackService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Conflux.Web3.Web3 web3, ENSRegistryWithFallbackDeployment eNSRegistryWithFallbackDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Cfx.GetContractDeploymentHandler<ENSRegistryWithFallbackDeployment>().SendRequestAndWaitForReceiptAsync(eNSRegistryWithFallbackDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Conflux.Web3.Web3 web3, ENSRegistryWithFallbackDeployment eNSRegistryWithFallbackDeployment)
        {
            return web3.Cfx.GetContractDeploymentHandler<ENSRegistryWithFallbackDeployment>().SendRequestAsync(eNSRegistryWithFallbackDeployment);
        }

        public static async Task<ENSRegistryWithFallbackService> DeployContractAndGetServiceAsync(Conflux.Web3.Web3 web3, ENSRegistryWithFallbackDeployment eNSRegistryWithFallbackDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public ENSRegistryWithFallbackService(Conflux.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
