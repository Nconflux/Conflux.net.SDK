...
using Conflux.BlockchainProcessing.BlockProcessing.CrawlerSteps;
...
namespace Conflux.BlockchainProcessing.BlockProcessing
{

    public class BlockCrawlOrchestrator: IBlockchainProcessingOrchestrator
    {
        public ICfxApiContractService EthApi { get; set; }
