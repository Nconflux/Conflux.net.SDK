...
using Conflux.StandardNonFungibleTokenERC721.ContractDefinition;

namespace Conflux.StandardNonFungibleTokenERC721
{
    public partial class ERC721Service
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Conflux.Web3.Web3 web3, ERC721Deployment eRC721Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Cfx.GetContractDeploymentHandler<ERC721Deployment>().SendRequestAndWaitForReceiptAsync(eRC721Deployment, cancellationTokenSource);
        }
        public static Task<string> DeployContractAsync(Conflux.Web3.Web3 web3, ERC721Deployment eRC721Deployment)
        {
            return web3.Cfx.GetContractDeploymentHandler<ERC721Deployment>().SendRequestAsync(eRC721Deployment);
        }
        public static async Task<ERC721Service> DeployContractAndGetServiceAsync(Conflux.Web3.Web3 web3, ERC721Deployment eRC721Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public ERC721Service(Conflux.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
