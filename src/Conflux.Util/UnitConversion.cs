...
namespace Conflux.Util
{
    public class UnitConversion
    {
        ...
        ///     significant digits
        /// </summary>
        public decimal FromDrip(BigInteger value, BigInteger toUnit)
        {
            return FromDrip(value, GetEthUnitValueLength(toUnit));
        }
        ...
        ///     significant digits
        /// </summary>
        public decimal FromDrip(BigInteger value, int decimalPlacesToUnit)
        {
            return (decimal) new BigDecimal(value, decimalPlacesToUnit * -1);
        }

        public BigDecimal FromDripToBigDecimal(BigInteger value, int decimalPlacesToUnit)
        {
            return new BigDecimal(value, decimalPlacesToUnit * -1);
        }

        public BigDecimal FromDripToBigDecimal(BigInteger value, EthUnit toUnit = EthUnit.Ether)
        {
            return FromDripToBigDecimal(value, GetEthUnitValue(toUnit));
        }

        public BigDecimal FromDripToBigDecimal(BigInteger value, BigInteger toUnit)
        {
            return FromDripToBigDecimal(value, GetEthUnitValueLength(toUnit));
        }
