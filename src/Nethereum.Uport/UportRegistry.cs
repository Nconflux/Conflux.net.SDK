...
namespace Conflux.Uport
{
    public class UportRegistryService
    {
        ...
        {
            this.web3 = web3;
            contract = web3.Cfx.GetContract(ABI, address);
        }
        ...
        {
            return web3.Cfx.DeployContract.SendRequestAsync(ABI, BYTE_CODE, addressFrom, gas, valueAmount,
