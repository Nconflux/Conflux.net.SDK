...
namespace Conflux.Parity.RPC.Admin
{
    ...
    ///     track: String - Track on which it was released, one of: "stable", "beta", "nightly", "testing", "null" (unknown or
    ///     self-built).
    ///     version: Object - Version number composed of major, minor and patch integers.
    ///     Example
    ///     Request
    ///     curl --data '{"method":"parity_versionInfo","params":[],"id":1,"jsonrpc":"2.0"}' -H "Content-Type:
