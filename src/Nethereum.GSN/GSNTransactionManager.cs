...
namespace Conflux.GSN
{
    public class GSNTransactionManager : IGSNTransactionManager
    {
        ...
        public GSNTransactionManager(
            ...
            ICfxApiContractService ethApiContractService,
            IClient client,
        ...
        private Conflux.Signer.Transaction ConvertToTx(RelayResponse response)
        {
            var tx = new Conflux.Signer.Transaction(
               response.To,
