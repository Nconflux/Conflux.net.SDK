    ...
    public class LoggingTest
    {
        ...
        public async void TestLogging()
        {
            if (_ethereumClientIntegrationFixture.Geth)
            {
                ...
                try
                {
                    var transactionHash2 = await web3.Cfx.DeployContract.SendRequestAsync(abi, contractByteCode,
                ...
                var transactionHash3 = await web3.Cfx.DeployContract.SendRequestAsync(abi, contractByteCode,
                    senderAddress,
                    new HexBigInteger(900000), 7);
