...
namespace Nethereum.Contracts.IntegrationTests.Deployment
{
    ...
    public class ContractDeploymentAndCall
    {
        ...
        public async void ShouldDeployAContractAndPerformACall()
        {
            ...
            var receipt = await web3.Cfx.DeployContract.SendRequestAndWaitForReceiptAsync(contractByteCode,
        ...
        public async void ShouldDeployAContractWithValueAndSendAValue()
        {
            ...
            var transaction =
                await
                    web3.Cfx.DeployContract.SendRequestAsync(abi, contractByteCode,
...
contract Purchase {
        ...
        inState(State.Locked)
    {
        ...
        public async void ShouldDeployUsingMultipleParameters()
        {
            ...
            var receipt =
                await
                    web3.Cfx.DeployContract.SendRequestAndWaitForReceiptAsync(abi, contractByteCode,
