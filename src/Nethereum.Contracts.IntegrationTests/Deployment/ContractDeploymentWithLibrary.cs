    ...
    public class ContractDeploymentWithLibrary
    {
        ...
        public void ShouldFailToDeployContractWithUnlinkedLibrary()
        {
            ...
            var ex = Assert.ThrowsAsync<Exception>(
                async () => await web3.Cfx.DeployContract.SendRequestAndWaitForReceiptAsync(contractByteCode,
        ...
        public async void ShouldDeployContractWithSingleLibrary()
        {
            ...
            var senderAddress = AccountFactory.Address;
            var web3 = _ethereumClientIntegrationFixture.GetWeb3();
            var libraryReceipt = await web3.Cfx.DeployContract.SendRequestAndWaitForReceiptAsync(libraryByteCode,
            ...
            var contractReceipt = await web3.Cfx.DeployContract.SendRequestAndWaitForReceiptAsync(contractByteCodeLinked,
                senderAddress, new HexBigInteger(900000), null, null, null);
            ...
            var contract = web3.Cfx.GetContract(abi, contractReceipt.ContractAddress);
        ...
        {
            // Deploy StringLib library
            var libraryStringByteCode = "";
            var senderAddress = AccountFactory.Address;
            var web3 = _ethereumClientIntegrationFixture.GetWeb3();
            var libraryStringReceipt = await web3.Cfx.DeployContract.SendRequestAndWaitForReceiptAsync(libraryStringByteCode,
                senderAddress, new HexBigInteger(900000), null, null, null);
            Assert.Equal(libraryStringReceipt.Status, new HexBigInteger(1));


            // Deploy OtherLib library
            var libraryOtherByteCode = "";
            var libraryOtherReceipt = await web3.Cfx.DeployContract.SendRequestAndWaitForReceiptAsync(libraryOtherByteCode,
                senderAddress, new HexBigInteger(900000), null, null, null);
            ...
            var abi = @"[{""constant"":true,""inputs"":[],""name"":""testOtherLibraryUse"",""outputs"":[{""name"":""result"",""type"":""string""}],""payable"":false,""stateMutability"":""pure"",""type"":""function""},{""constant"":true,""inputs"":[],""name"":""testStringLibraryUse"",""outputs"":[{""name"":""result"",""type"":""string""}],""payable"":false,""stateMutability"":""pure"",""type"":""function""}]";
            var contract = web3.Cfx.GetContract(abi, contractReceipt.ContractAddress);
