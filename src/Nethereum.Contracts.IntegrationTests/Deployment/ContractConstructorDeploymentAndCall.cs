    ...
    public class ContractConstructorDeploymentAndCall
    {
        ...
        public async void ShouldDeployAContractWithConstructor()
        {
           ...
           */
            ...
            var transactionHash = await web3.Cfx.DeployContract.SendRequestAsync(abi, contractByteCode, senderAddress,
        ...
        public async void ShouldEstimateContactDeployment()
        {
            ...
            var senderAddress = AccountFactory.Address;
            var web3 = _ethereumClientIntegrationFixture.GetWeb3();
            var estimate = await web3.Cfx.DeployContract.EstimateGasAsync(abi, contractByteCode, senderAddress, 7);
