    ...
    public class EventFilterWith2Topics
    {
        ...
        public async Task Test()
        {
           ...
           */
            ...
            var transactionHash = await web3.Cfx.DeployContract.SendRequestAsync(abi, contractByteCode, addressFrom,
            ...
            var receipt = await web3.Cfx.Transactions.GetTransactionReceipt.SendRequestAsync(transactionHash);
            ...
            var code = await web3.Cfx.GetCode.SendRequestAsync(receipt.ContractAddress);
            ...
            var logs = await web3.Cfx.Filters.GetFilterChangesForEthNewFilter.SendRequestAsync(filterAllContract);
