    ...
    public class AnonymousEventFilterWith2Topics
    {
        ...
        public async Task TestEvent()
        {
            ...
            var deploymentTransactionReceipt = await DoTransactionAndWaitForReceiptAsync(web3,
                () => web3.Cfx.DeployContract.SendRequestAsync(abi, bytecode, addressFrom, new HexBigInteger(900000)));

            var code = await web3.Cfx.GetCode.SendRequestAsync(deploymentTransactionReceipt.ContractAddress);
            ...
            var contract = web3.Cfx.GetContract(abi, deploymentTransactionReceipt.ContractAddress);
