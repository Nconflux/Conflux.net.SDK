...
namespace Nethereum.Contracts.IntegrationTests.SmartContracts
{
    ...
    public class ErrorReasonTest
    {
        ...
        public async void ShouldRetrieveErrorReason()
        {
            ...
            var errorReason = await web3.Cfx.GetContractTransactionErrorReason.SendRequestAsync("0x2b90deeeb87db3b2b83a91afc48dcc56ce46d1ad84cab1c8864d980dbdec47ec");
        ...
        public async void ShouldThrowErrorDecodingCall()
        {
            ...
            if (_ethereumClientIntegrationFixture.Geth)
            {
                ...
                var transactionReceiptDeployment = await web3.Cfx.GetContractDeploymentHandler<ErrorThrowDeployment>()
                    .SendRequestAndWaitForReceiptAsync(errorThrowDeployment);
                var contractAddress = transactionReceiptDeployment.ContractAddress;

                var contractHandler = web3.Cfx.GetContractHandler(contractAddress);
