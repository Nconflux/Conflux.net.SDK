...
namespace Nethereum.Contracts.IntegrationTests.CQS
{
    ...
    public class SimpleMessage
    {
        ...
        public async void TestCQS()
        {
            ...
            var deploymentHandler = web3.Cfx.GetContractDeploymentHandler<TestContractDeployment>();
            var transactionReceipt = await deploymentHandler.SendRequestAndWaitForReceiptAsync(deploymentMessage);

            var contractHandler = web3.Cfx.GetContractHandler(transactionReceipt.ContractAddress);
        ...
        public async void TestOriginal()
        {
            ...
            var receipt = await web3.Cfx.DeployContract.SendRequestAndWaitForReceiptAsync(abi, byteCode, senderAddress, new HexBigInteger(900000));
