...
namespace Nethereum.Contracts.IntegrationTests.CQS
{
    ...
    public class ContractHandlers
    {
        ...
        public async void ShouldDecodeTransactionDeployment()
        {
            ...
            var deploymentHandler = web3.Cfx.GetContractDeploymentHandler<StandardTokenDeployment>();
            var transactionReceipt = await deploymentHandler.SendRequestAndWaitForReceiptAsync(deploymentMessage);

            var transaction = await web3.Cfx.Transactions.GetTransactionByHash.SendRequestAsync(transactionReceipt.TransactionHash);
        ...
        public async void ShouldDecodeTransactionInput()
        {
            ...
            var transferHandler = web3.Cfx.GetContractTransactionHandler<TransferFunction>();
            var transferReceipt =
                await transferHandler.SendRequestAndWaitForReceiptAsync(contractAddress, transactionMessage);

            var transaction = await web3.Cfx.Transactions.GetTransactionByHash.SendRequestAsync(transferReceipt.TransactionHash);
        ...
        public async void Test()
        {
            ...
            var balanceHandler = web3.Cfx.GetContractQueryHandler<BalanceOfFunction>();
