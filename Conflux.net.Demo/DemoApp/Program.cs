...
namespace DemoApp
{
    class Program
    {
        static string url = "http://test.confluxrpc.org/v2";
        static string privateKey = "a816a06117e572ca7ae2f786a046d2bc478051d0717bf5cc4f5397923258d393";
        static NConflux conflux = new NConflux(url);
        static void Main(string[] args)
        {
            //var privateKey =  NConflux.GeneratePrivateKey();
            //var account = new Account(privateKey);
            var newAddress = Base32.Encode("0x14898cd5d2bda3a225c3bed54b70a8f4349fc007", NetworkType.cfx);
            var oldAddress = Base32.Decode("cfx:aamjxdgz4m84hjvf2s9rmw5uzd4dkh8aa6dgu8b6ag");
        ...
        {
            return await conflux.GetBalance("cfxtest:aatutrr8egewvwsu22f3gsh2yezhysemhuuv6py0tz");
        }
